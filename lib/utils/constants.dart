...
const String REGISTER_APP = "Registrate";
const String LOGIN_APP = "Ingresa";

const String NOMBRE_FIELD = "Nombre completo";
const String PASSWORD_FIELD = "Password";
const String EMAIL_FIELD = "Email";
const String FORGOT_PASSWORD = "¿Olvidaste tu contraseña?";
const String INGRESS_APP = "Ingresar";
